"""
Standalone Marstek Venus E API Client.

This is a standalone version of the API client that can be used
without Home Assistant for testing and development.

Usage:
    from marstek_api import MarstekApiClient

    client = MarstekApiClient("192.168.1.195", 30000)
